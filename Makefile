...
lint-py:  ## lint python with ruff
	python -m ruff check pydantic_systemd
	python -m ruff format --check pydantic_systemd
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix pydantic_systemd
	python -m ruff format pydantic_systemd
...
test:  ## run python tests
	python -m pytest -v pydantic_systemd/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v pydantic_systemd/tests --cov=pydantic_systemd --cov-report term-missing --cov-report xml
